...
Topic_Info::Topic_Info()
{
    ...
    for(int i=0;i<MAXNUM_AGENT;i++)
        allocation2terminal_sub_[i]=nh_->subscribe <allocation_common::allocation2terminal_info>
                ("Robot"+std::to_string(i)+"/task_allocation/allocation2terminal_info",MAXNUM_AGENT,boost::bind(&Topic_Info::update_allocation_info,this,_1,i));
}
...
void Topic_Info::publish(const ros::TimerEvent &)
{
    ...
    // terminal2robots_info.greedorprobability = 0; //greed 0; probability 1;
