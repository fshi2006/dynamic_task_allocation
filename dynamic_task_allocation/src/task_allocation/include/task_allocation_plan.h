#ifndef TASK_ALLOCATION_PLAN_H
#define TASK_ALLOCATION_PLAN_H
...
private:
    ...
    ros::Publisher     drawing_pub_,which_task_pub;
    ros::Timer         allocation_timer;
    ros::NodeHandle*   nh_;
};

#endif // TASK_ALLOCATION_PLAN_H
